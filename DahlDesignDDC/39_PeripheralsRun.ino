...
void conditionalWrite(uint8_t screenNumber, bool clear, bool post, bool condition, const char* text, uint8_t color, float textSize, uint8_t cursorX, uint8_t cursorY) 
{
  int index = screenNumber - 1;
