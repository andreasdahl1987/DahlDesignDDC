...
void rotary2Throttle(int8_t row, int8_t col, bool reverse)
{
    int8_t Row = row - 1;
    int8_t Column = col - 1;
...
void rotary2Brake(int8_t row, int8_t col, bool reverse)
{
    int8_t Row = row - 1;
    int8_t Column = col - 1;
    int8_t Number = buttonNumber[Row][Column];
...
void rotary2BiteAdjust(int8_t row, int8_t col, bool reverse, int increment)
{
    int8_t Row = row - 1;
    int8_t Column = col - 1;
    int8_t Number = buttonNumber[Row][Column];
    ...
    int8_t difference = pushState[Row][Column + 1];
    if (difference != 0 && pushState[biteButtonRow - 1][biteButtonCol - 1] == 0)
    {
        if (globalClock - switchTimer[Row][Column + 1] < encoder2Pulse + encoder2Wait)
        {
            if ((difference > 0 && difference < 2) || difference < -2)
...
void rotary2Preset(int8_t row, int8_t col, bool reverse)
{
    int8_t Row = row - 1;
    int8_t Column = col - 1;
    int8_t Number = buttonNumber[Row][Column];
