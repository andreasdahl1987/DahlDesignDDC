...
SSD1306push("Menu options", 2, 24,12, false); //push writes to same screen with same color. Changable text size (2) and coordinates (24,12). Send result, dont wait for more.

SSD1306clearPush(2,"OLED", 1, 2, 0, 0, true): 
SSD1306push("DDC", 2, 24,12, false);
